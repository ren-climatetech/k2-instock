  ...
  return (
    <form className="add-inventory__form" onSubmit={handleSubmit}>
      <div className="add-inventory__form-wrapper">
        <div className="add-inventory__form-wrapper_inventory">
          <h2 className="add-inventory__form-wrapper_inventory-title">
            Inventory Details
          </h2>
          <label className="add-inventory__form-wrapper_inventory-label">
            Item Name
          </label>
          <input
            className={`add-warehouse__form-wrapper_inventory-input ${
          ...
          />
          {errors.item_name && (
            <span className="add-inventory__form-wrapper_inventory-input__error">
              {errors.item_name}
            </span>
          )}
          <label className="add-inventory__form-wrapper_inventory-label">
